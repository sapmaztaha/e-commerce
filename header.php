						...
						<div class="navbar-collapse collapse">
							<ul class="nav navbar-nav">
								...
								<?php 
										...
										$menusor=$db->prepare("SELECT * FROM menu WHERE menu_durum=:menu_durum ORDER BY menu_sira ASC LIMIT 5"); // menuleri sira numaralarına göre sıraladık (oreder by) ve maksimum 5 adet gösterilmesini sağladık (asc limit 5)
										$menusor->execute(
											[
												'menu_durum' => 1 // menu_durumu pasif olanların gözükmemesi sağlıyor
											]	
										);
