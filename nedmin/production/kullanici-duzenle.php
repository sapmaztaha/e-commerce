...
if (!isset($_GET['kullanici_id']) || empty(trim($_GET['kullanici_id']))) {  //eğer kullanıcı id yoksa kullanici.php yönlendir;
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Kullanıcı Düzenleme İşlemleri</h2>
                    ...
                    <form action="../netting/islem.php" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="kullanici_tc" value="<?php echo $kullanicicek['kullanici_tc']; ?> ">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="kullanici_adsoyad" value="<?php echo $kullanicicek['kullanici_adsoyad']; ?> ">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="kullanici_mail" disabled="" value="<?php echo $kullanicicek['kullanici_mail']; ?> ">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="kullanici_gsm" value="<?php echo $kullanicicek['kullanici_gsm']; ?> ">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="first-name" required="required" class="form-control col-md-7 col-xs-12" name="kullanici_zaman" disabled   value="<?php echo $zaman[0]; ?> ">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          ...
                          <button type="submit" class="btn btn-success" name="kullaniciduzenle">Düzenle</button>
