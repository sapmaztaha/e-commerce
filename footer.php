		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author']; ?><a href="index.php">website</a></div>
				...
				<div class="col-md-3"><!--footer Share-->
					...
					<div class="fsoc">
						...
						<a href="http://<?php echo $ayarcek['ayar_youtube'] ?>" class="fflickr">flickr</a>
						<a href="http://<?php echo $ayarcek['ayar_google'] ?>" class="ffeed">feed</a>
						<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div><!--footer Share-->
